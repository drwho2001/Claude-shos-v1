...
// -----------------------
// Real ask, Kane's own example: edit an Encounter (change the date,
...
// differently.
//
// SCOPE, deliberately matching what's already built and what Kane
...
//   benefit Kane didn't ask for, and risks becoming exactly the kind
//   of over-built feature flagged earlier this session as worth
//   pushing back on.
// - Scoped to ONE module/page at a time, per Kane's explicit
...
// - Covers EDITS to an existing record (Kane's actual example — change
...
export function useEditUndo(repository) {

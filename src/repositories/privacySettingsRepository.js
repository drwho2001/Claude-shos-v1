...
// -----------------------
// Anonymise mode — Kane's real, scoped ask: "no anonymous never as
...
//
// TWO TIERS, per Kane's exact wording:
...
// Both tiers are scoped to Contacts — those are the fields Kane
...
export const DEFAULT_PRIVACY_SETTINGS = {
  ...
  // default, per Kane's explicit instruction.
...
export const PrivacySettingsRepository = {
  ...
  // reverts directly (won't lock Kane out of his own app for

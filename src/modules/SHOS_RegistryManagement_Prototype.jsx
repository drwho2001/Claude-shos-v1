...
//
// DELIBERATELY NOT BUILT — merge. Kane's own past framing named merge
      ...
      <div key={entry.id} style={{ display: "flex", alignItems: "center", gap: 10, padding: "12px 14px", borderBottom: `1px solid ${T.border}` }}>
        {isEditing ? (
          <input autoFocus value={editingName} onChange={(e) => setEditingName(e.target.value)}
            ...
            onBlur={commitEdit}
            style={{ flex: 1, padding: "6px 8px", borderRadius: 8, border: `1px solid ${color}`, fontSize: 14, fontFamily: "'Public Sans', sans-serif" }} />
        ) : (
